...
class recommender:
    def __init__(self, data, k=1, metric='pearson', n=5):
        ...
        k is the k value for k nearest nieghbor
        metric is which distance formula to use
        n is the maxium number of recommendations to make
        """
        self.k = k
        self.n = n
        self.username2id = {}
    ...
    def loadBookDB(self):
        ...
        # self.username2id
        #
        f = codecs.open('BX-Users.csv', 'r', 'utf8')
        for line in f:
            i += 1
            # separate line into fields
            fields = line.split(';')
    ...
    def recommend(self, user):
        ...
        for i in range(self.k):
            ...
            name = nearest[i][0]
            # get the ratings for the person
